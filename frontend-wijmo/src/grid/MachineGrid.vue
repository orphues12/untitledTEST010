<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['name','modelName','groupId','machineUser',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="machineUser[0].name" header="machineUser" width="2*" :isReadOnly="true" align="center" />
        ...
        <MachineUserDetailGrid :selectedGrid="selectedGrid" />
...
import MachineUserDetailGrid from './MachineUserDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.machineUser;
