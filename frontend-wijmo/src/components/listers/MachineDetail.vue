<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <GroupId offline label="GroupId" v-model="item.groupId" :editMode="false" :key="false" @change="change" />
            <MachineUserManager offline label="MachineUser" v-model="item.machineUser" :editMode="false" @change="change" />
        </v-card-text>
