<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <GroupId offline label="GroupId" v-model="value.groupId" :editMode="editMode" @change="change"/>
            <MachineUserManager offline label="MachineUser" v-model="value.machineUser" :editMode="editMode" @change="change"/>
        </v-card-text>
